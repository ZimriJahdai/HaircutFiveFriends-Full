 ...
 */
export const BarberEmptyState = ({ variant, onAdd }) => {
  if (variant === 'loading') {
    return (
  ...
  return (
    <div className="flex flex-col items-center gap-3.5 py-16 text-[#5A5A5A] text-[14px] text-center">
      <i className="ti ti-id-badge text-5xl text-[#333]" aria-hidden="true" />
      <h3 className="m-0 text-[#E8E4DC] text-[16px] font-semibold">No hay barberos registrados</h3>
      <p className="m-0 text-[#5A5A5A] text-[13px]">Agrega tu primer barbero para empezar</p>
      <button
        type="button"
        onClick={onAdd}

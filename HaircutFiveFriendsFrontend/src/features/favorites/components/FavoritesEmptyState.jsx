    ...
    return (
      <div className="flex flex-col items-center gap-5 py-24 text-center">
        ...
        <div>
          ...
          <p className="text-[#5A5A5A] text-[13px] max-w-md mx-auto">
            Ve a las diferentes secciones y presiona{' '}
            <i className="ti ti-heart text-[#00D2C4]" aria-hidden="true" />{' '}
            para guardar los cortes, productos, servicios o barberos que más te gusten.
          </p>
        </div>
        <Link
          to="/client/barberos"

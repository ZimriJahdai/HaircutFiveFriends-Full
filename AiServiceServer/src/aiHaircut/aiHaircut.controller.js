 ...
 *   - description   : descripcion libre del corte deseado
 *   - length        : "short" | "medium" | "long"
 *   - style         : "classic" | "modern" | "urban"
 *
 * Respuesta:
 *   {
 *     faceSummary       : string  - analisis del rostro
 *     haircutImageBase64: string  - imagen generada en base64
 *     haircutParams     : object  - parametros usados
 *   }
 */
  ...
  try {
    ...
    if (resolvedImageBase64 && !cleanBase64) {
      return res.status(400).json({
        success: false,
        message: "imageBase64 no es valido",
      });
    }
